...
/**
 * Pure date math for subscription periods (PRD #6-#8: monthly = +1 month,
 * yearly = +365 days). Kept out of both the Subscription model and
...
class SubscriptionPeriod
{
    ...
    {
        return match ($type) {
            Subscription::TYPE_MONTHLY => $startsAt->copy()->addMonth(),
            Subscription::TYPE_YEARLY => $startsAt->copy()->addDays(365),
